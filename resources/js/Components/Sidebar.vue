        ...
        >
            ...
            <nav class="mt-10">
                ...
                <inertia-link
                    ...
                    :class="route().current('admin.projects') || route().current('admin.images') || route().current('admin.projects.new') ? 'bg-gray-600 bg-opacity-25 text-gray-100 border-gray-100' : null"
                    class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4 text-white">
                    Projects
               </inertia-link>
               <inertia-link
