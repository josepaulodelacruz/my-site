<template>
    <article @click="viewBlog" class="flex-col overflow-hidden bg-white w-56 h-56 mr-3 mb-6 rounded-lg shadow-lg">
        <a href="#">
            <img alt="Placeholder" class="block h-1/2 w-full object-fill" :src="'/images/blogs/' + blog.image">
        </a>
        ...
        <footer class="flex items-center justify-between leading-none p-2 md:p-4">
            ...
            <div class="flex">
                <button @click="blogDelete(blog)" class="mr-1 bg-red-500 rounded-lg p-1">
                ...
                <button class=" bg-blue-500 rounded-lg p-1">
